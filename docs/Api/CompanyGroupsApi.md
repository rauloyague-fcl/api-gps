# Swagger\Client\CompanyGroupsApi

All URIs are relative to *https://localhost/fleet/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createCompanyGroup**](CompanyGroupsApi.md#createCompanyGroup) | **POST** /accounts/companygroups | 
[**deleteCompanyGroup**](CompanyGroupsApi.md#deleteCompanyGroup) | **DELETE** /accounts/companygroups/{id} | 
[**getCompanyGroup**](CompanyGroupsApi.md#getCompanyGroup) | **GET** /accounts/companygroups/{id} | 
[**listCompanyGroups**](CompanyGroupsApi.md#listCompanyGroups) | **GET** /accounts/companygroups | 
[**updateCompanyGroup**](CompanyGroupsApi.md#updateCompanyGroup) | **PUT** /accounts/companygroups/{id} | 
...
$apiInstance = new Swagger\Client\Api\CompanyGroupsApi(
...
try {
    ...
    echo 'Exception when calling CompanyGroupsApi->createCompanyGroup: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling CompanyGroupsApi->deleteCompanyGroup: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling CompanyGroupsApi->getCompanyGroup: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling CompanyGroupsApi->listCompanyGroups: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling CompanyGroupsApi->updateCompanyGroup: ', $e->getMessage(), PHP_EOL;
}
?>
```
