...
class NotificationsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\TestNotificationsRequest $request request (required)
     *
    ...
    {
        list($response) = $this->testNotificationWithHttpInfo($request);
        return $response;
    }
     ...
     *
     * @param  \Swagger\Client\Model\TestNotificationsRequest $request (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SuccessResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function testNotificationWithHttpInfo($request)
    {
        $returnType = '\Swagger\Client\Model\SuccessResponse';
        $request = $this->testNotificationRequest($request);
     ...
     */
    public function testNotificationAsync($request)
    {
        return $this->testNotificationAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testNotificationAsyncWithHttpInfo($request)
    {
        $returnType = '\Swagger\Client\Model\SuccessResponse';
        $request = $this->testNotificationRequest($request);
     ...
     */
    protected function testNotificationRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling testNotification'
            );
        }
