...
class ApiKey implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'policies' => '\Swagger\Client\Model\Policy[]'
    ];
     ...
     * Sets name
     *
     * @param string $name Provide a descriptive name for your API key
     *
     * @return $this
     */
     ...
     * Sets policies
     *
     * @param \Swagger\Client\Model\Policy[] $policies specify an optional set of policies that will be merged with the user's policies when this key is used
     *
     * @return $this
     */
