...
/**
 * AssetTagListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssetTagListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssetTagListItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['asset_tag_type'] === null) {
            $invalidProperties[] = "'asset_tag_type' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id The unique UUID for this Asset Tag
     *
     * @return $this
     */
     ...
     * Sets owner
     *
     * @param \Swagger\Client\Model\IdName $owner The client that owns this Asset Tag
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The serial number of the Asset Tag that is used to uniquely identify it.
     *
     * @return $this
     */
