<?php
/**
 * DashboardTemplateCreateRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DashboardTemplateCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DashboardTemplateCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DashboardTemplateCreateRequest';
     ...
     * Sets dashboard_id
     *
     * @param string $dashboard_id The id of the dashboard to turn into a template
     *
     * @return $this
     */
     ...
     * Sets owner_id
     *
     * @param string $owner_id The ownerId of the template
     *
     * @return $this
     */
     ...
     * Sets user
     *
     * @param \Swagger\Client\Model\IdName $user The id of the user who created the template
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the dashboard template.
     *
     * @return $this
     */
     ...
     * Sets public
     *
     * @param bool $public Determines if the dashboard can be added by downstream users
     *
     * @return $this
     */
