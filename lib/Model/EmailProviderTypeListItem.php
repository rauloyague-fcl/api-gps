...
/**
 * EmailProviderTypeListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmailProviderTypeListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmailProviderTypeListItem';
     ...
     * Sets name
     *
     * @param string $name The name of the email provider type
     *
     * @return $this
     */
     ...
     * Sets tag
     *
     * @param string $tag The tag to apply to the email provider type
     *
     * @return $this
     */
     ...
     *
     * @param string $parameter_definition The parameters used by the email provider type
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state The state of the email provider type
     *
     * @return $this
     */
