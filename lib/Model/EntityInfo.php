...
class EntityInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EntityInfo';
     ...
     * Sets creation_date
     *
     * @param string $creation_date The ISO date this company was created
     *
     * @return $this
     */
     ...
     * Sets modified_date
     *
     * @param string $modified_date The ISO date that this company was last modified
     *
     * @return $this
     */
