...
class NotFoundError implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['status'] = isset($data['status']) ? $data['status'] : 404.0;
        $this->container['name'] = isset($data['name']) ? $data['name'] : 'NotFoundError';
        $this->container['message'] = isset($data['message']) ? $data['message'] : 'The resource you requested could not be found';
    }
