 ...
 *
 * @category    Class
 * @description The ClientUpdateRequest is used to update an existing entity. All fields are optional and can be individually supplied to the update method.
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ClientUpdateRequestTest extends \PHPUnit_Framework_TestCase
{
